...
namespace WFInfo.LanguageProcessing
{
    ...
    public class KoreanLanguageProcessor : LanguageProcessor
    {
        private static readonly List<KeyValuePair<string, string>> koreanReplacements = new List<KeyValuePair<string, string>>
        {
            ...
            new KeyValuePair<string, string>("고", "go"), new KeyValuePair<string, string>("과", "gwa"), new KeyValuePair<string, string>("궈", "gwo"), new KeyValuePair<string, string>("괘", "gwae"), new KeyValuePair<string, string>("괴", "goe"), new KeyValuePair<string, string>("교", "gyo"), new KeyValuePair<string, string>("구", "gu"),
            ...
            new KeyValuePair<string, string>("노", "no"), new KeyValuePair<string, string>("놔", "nwa"), new KeyValuePair<string, string>("놰", "nwae"), new KeyValuePair<string, string>("뇌", "noe"), new KeyValuePair<string, string>("뇨", "nyo"), new KeyValuePair<string, string>("누", "nu"), new KeyValuePair<string, string>("뉘", "nwi"),
            ...
            new KeyValuePair<string, string>("도", "do"), new KeyValuePair<string, string>("돠", "dwa"), new KeyValuePair<string, string>("돼", "dwae"), new KeyValuePair<string, string>("됴", "dyo"), new KeyValuePair<string, string>("두", "du"), new KeyValuePair<string, string>("둬", "dwo"), new KeyValuePair<string, string>("뒈", "dwe"),
            ...
            new KeyValuePair<string, string>("코", "ko"), new KeyValuePair<string, string>("콰", "kwa"), new KeyValuePair<string, string>("쾌", "kwae"), new KeyValuePair<string, string>("쾨", "koe"), new KeyValuePair<string, string>("쿄", "kyo"), new KeyValuePair<string, string>("쿠", "ku"), new KeyValuePair<string, string>("퀘", "kwe"),
        ...
        private static readonly IReadOnlyDictionary<string, string> _ignoredItemNames = new Dictionary<string, string>
        {
            ...
            ["Sagek Prime Blueprint"] = "사게크 프라임 설계도",
            ["Sagek Prime Barrel"] = "사게크 프라임 배럴 설계도",
            ["Sagek Prime Receiver"] = "사게크 프라임 리시버 설계도"
        };
