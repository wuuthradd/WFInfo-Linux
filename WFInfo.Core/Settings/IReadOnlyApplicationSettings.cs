...
{
    /// <summary>
    /// Readonly copy of the settings for services to use (cross-platform).
    /// </summary>
    public interface IReadOnlyApplicationSettings
    {
        ...
        VirtualMouseButton? ActivationMouseButton { get; }
        VirtualKey DebugModifierKey { get; }
        VirtualKey SearchItModifierKey { get; }
        VirtualKey SnapitModifierKey { get; }
        VirtualKey MasterItModifierKey { get; }
        bool Debug { get; }
        string Locale { get; }
        bool Clipboard { get; }
        long AutoDelay { get; }
